			...
			<div>
				...
				<h2>Design Changes</h2>
					...
					<h3>New user pop-up</h3>
						...
						<p><b>Images</b> </p>
					<h3>Exposing platform activity (+cards)</h3>
						...
						<p><b>Design change:</b> To expose recent activity on the app, I added blocks in the page headers for Locations, Observations and Issues pages that showed a count of the number of Locations/Observations/Issues reported as well as the number reported in the last 30 days (see Figure 3). I also added a section to the cards for Groups and Locations page that indicated the last observation date for the Group/Location. These changes helped expose recent activity to new users and motivate them to join the community.</p>
						<p><b>Images</b> </p>
				<h2>Results</h2>
					<p>
					</p>
